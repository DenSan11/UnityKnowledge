...
public class KnapsackManager : MonoBehaviour
{
    ...
    //public Dictionary<int, Goods> ItemList1;
    ...
    {
        Vector2 position;
        //把鼠标屏幕位置转换为视图位置，第3参数是Canvas Render Mode为Screen Space-Camera 的Camera
    ...
    //    ItemList1 = new Dictionary<int, Goods>();
    //    for (int i = 0; i < wuqi.WuQiConfigs.Length; i++)
    //    {
    //        ItemList1.Add(wuqi.WuQiConfigs[i].id-1, wuqi.WuQiConfigs[i]);
    //    }
    //    Debug.Log(wuqi.WuQiConfigs.Length);
    //}
