...
namespace SUIFW
{
    ...
    public class SysDefine : MonoBehaviour {
        /* 路径常量 */
        public const string SYS_PATH_CANVAS = "SUIFW_Res/Canvas";
        public const string SYS_PATH_UIFORMS_CONFIG_INFO = "SUIFW_Res/UIFormsConfigInfo";
        public const string SYS_PATH_CONFIG_INFO = "SUIFW_Res/SysConfigInfo";
        public const string SYS_PATH_LAUGUAGE_JSON_CONFIG = "SUIFW_Res/LauguageJSONConfig";
