...
namespace SUIFW
{
	public class UIManager : MonoBehaviour {
        ...
        /// 
        /// 修改记录：
        ///     本方法20180918，修改目的是让大量UI窗体可以直接打开相应的目标窗体。
        ...
        public void ShowUIForms(string uiFormName, bool IsRedirection=false)
        {
            ...
            //if (IsRedirection)
            //{
            //    //print(GetType() + "/ShowUIForms()/IsRedirection==true 使用直接跳转模式");
            //}

            //根据UI窗体的名称，加载到“所有UI窗体”缓存集合中
            baseUIForms = LoadFormsToAllUIFormsCatch(uiFormName);//此时UI预设窗体(根据“位置模式”)已经加载到层级试图的相应位置了
        ...
        //    //如果“正在显示”的集合中，存在本UI窗体，则直接返回(无需重复)
